...
export default function Home() {
  ...
  return (
    <>
      <Loader onLoadingComplete={() => setPageLoaded(true)} />
          ...
          <header className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 w-full full-width ${
            ...
            <AnimatePresence>
              {mobileMenuOpen && (
                ...
                >
                  <div className={`bg-white shadow-xl rounded-b-xl mx-4 mt-2 ${isRTL ? 'mr-auto ml-4 left-0' : 'ml-auto mr-4 right-0'} absolute w-64 max-w-xs border border-gray-100`}>
