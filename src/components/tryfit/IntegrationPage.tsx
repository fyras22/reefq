...
export default function IntegrationPage({ lang = "en" }: IntegrationPageProps) {
  ...
  const mockTranslation: SimpleTranslationFunction = (key: string): string => {
    ...
    const translations: Record<string, string> = {
      ...
      "tryFit.pageSubtitle":
        "Try on jewelry virtually and determine your exact size",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center">
                <Link
                  href="/"
                  className="flex items-center text-nile-teal hover:text-nile-teal/90 transition-colors"
                >
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">
                  {mockTranslation("tryFit.pageTitle")}
                </h1>
              </div>
              <div className="w-24">{/* Empty div for balance */}</div>
            </div>
          </div>
        </header>
            ...
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-10">
                ...
                <p className="text-lg text-gray-600">
                  {mockTranslation("tryFit.pageSubtitle")}
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex space-x-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">
                        Properly sized jewelry ensures all-day comfort without
                  ...
                  <div className="flex space-x-4">
                    <div className="flex-shrink-0">
                      <div className="h-12 w-12 rounded-full bg-pharaonic-gold/10 flex items-center justify-center">
                        <span className="text-pharaonic-gold font-semibold">
                          2
                        </span>
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">
                        Finding your size before purchase significantly reduces
                  ...
                  <div className="flex space-x-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">
                        Properly fitted jewelry lasts longer and maintains its
                        beauty over time.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex space-x-4">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">
                        Shop with confidence knowing exactly which size to
                        select for your jewelry.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <footer className="bg-gray-900 text-white py-12 mt-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h3 className="text-2xl font-semibold text-pharaonic-gold mb-4">
                Reefq
              </h3>
              ...
              <p className="mt-8 text-sm text-gray-400">
                © 2023 Reefq. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
