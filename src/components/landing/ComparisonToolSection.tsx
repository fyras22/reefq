            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  >
                    {activeTab !== "reefq" &&
                      competitors[activeTab as keyof typeof competitors].name}
                  </th>
                </tr>
              </thead>
                ...
                {features.map((feature) => (
                  <tr key={feature.id}>
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      {competitors.reefq.features[
                        feature.id as keyof typeof competitors.reefq.features
                      ] ? (
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                      {activeTab !== "reefq" &&
                        (competitors[activeTab as keyof typeof competitors]
                          .features[
                          feature.id as keyof typeof competitors.reefq.features
                        ] ? (
                          <CheckIcon className="h-5 w-5 text-green-500" />
