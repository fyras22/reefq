      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        {isRTL ? (
          <div className="text-center">
            {/* Adjusted logo container for better control */}
            <div className="mb-6 flex justify-center">
              <div className="relative h-12 w-48">
                <Image
                  ...
                  fill
                  sizes="192px" // Provide size hint
                  className="object-contain" // Use object-contain
                  priority // Can potentially remove priority if not above the fold
                />
              </div>
            </div>
            <p className="text-lg text-gray-300 mb-6">{t('footer.copyright', { year: new Date().getFullYear() })}</p>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
              <div>
                <div className="flex items-center mb-4">
                  {/* Consider using Image component for logo here as well for consistency */}
                  <span className="text-3xl font-bold text-pharaonic-gold font-serif mr-2">ReefQ</span>
                </div>
                <p className="text-gray-300 mt-4 text-sm">
                  {t('footer.tagline', 'Your first draft is our final masterpiece ✨')}
                </p>
              </div>
              <div>
