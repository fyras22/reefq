    ...
    <footer className="bg-gray-900" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-8">
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-base font-medium text-white">{t('footer.resources')}</h3>
                <ul className="mt-4 space-y-4">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-base font-medium text-white">{t('language.switchLanguage')}</h3>
        ...
        <div className="mt-16 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <p className="mt-4 md:mt-0 text-sm text-gray-400 md:order-2">
