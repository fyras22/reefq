    ...
    <section className="py-24 bg-gray-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Connection line */}
          <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-nile-teal/20" style={{ transform: 'translateX(-50%)' }}></div>
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="md:w-1/2 text-center md:text-left">
                  <div className={`inline-flex h-8 w-8 items-center justify-center rounded-full bg-nile-teal text-white text-lg font-semibold mb-4`}>
                    {index + 1}
                  </div>
