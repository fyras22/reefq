  ...
  return (
    <div className="relative w-full bg-gradient-to-r from-gray-900 to-gray-700 text-white overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-64 h-64 -translate-y-1/4 translate-x-1/4 opacity-10">
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full fill-yellow-500">
          <path d="M45.3,-51.2C58.9,-40.6,70.3,-25.3,73.8,-7.9C77.3,9.5,73,29,62.2,43.1C51.5,57.3,34.2,66.1,15.4,70.5C-3.4,74.8,-23.7,74.6,-39.3,65.9C-54.9,57.2,-65.8,40.1,-71.3,20.9C-76.9,1.8,-77.2,-19.5,-68.1,-34.8C-59.1,-50.1,-40.6,-59.4,-22.9,-67.1C-5.2,-74.7,11.8,-80.6,26.2,-74.4C40.7,-68.1,52.5,-49.8,45.3,-51.2Z" transform="translate(100 100)" />
        </svg>
      </div>
      
      <div className="absolute bottom-0 left-0 w-64 h-64 translate-y-1/3 -translate-x-1/3 opacity-10">
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full fill-yellow-400">
          <path d="M38.5,-46C52.9,-34.4,69.7,-24.3,71.8,-11.9C74,0.5,61.6,15.3,49.7,25.5C37.8,35.7,26.3,41.3,12.6,48.6C-1.1,55.9,-17,64.9,-29.7,61.3C-42.3,57.6,-51.7,41.3,-56.7,24.5C-61.7,7.8,-62.3,-9.3,-55.8,-23C-49.2,-36.7,-35.4,-47,-21.5,-58.3C-7.6,-69.6,6.4,-81.9,18.1,-76.2C29.9,-70.6,39.6,-47.2,38.5,-46Z" transform="translate(100 100)" />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <nav className="flex mb-6 text-sm md:text-base">
          ...
          <span className="text-white font-medium">{t('collections.title')}</span>
        </nav>
